...
if (isset($_GET["action"])) {
  ...
  switch ($_GET["action"]) {
    case "delete":
      $id = $_GET['id'];
      $urunquery = mysqli_query($conn, "SELECT * FROM urunler WHERE id='$id'");
      $urun = mysqli_fetch_assoc($urunquery);

      unlink("./dosyalar/" . $urun["kucukresim"]);
      unlink("./dosyalar/" . $urun["buyukresim"]);
        ...
        <div class="content-wrapper">
          <div class="page-header">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="urunler.php">Ürünler</a></li>
              </ol>
            </nav>
          </div>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <button type="button" class="btn btn-light"><a href="urunekle.php">Ürün Ekle</a></button></br>

                <script>
                  function sil(id) {
                    if (confirm('Silinsin mi?')) {
                      window.location.href = "urunler.php?id=" + id + "&action=delete";
                    }
                  }
                </script>
                ...
                <div class="table-responsive"></br>
                  <table class="table table-bordered ">
                    <thead>
                      <tr>
                        <th class="text-warning"><b> Ürün adı</b> </th>
                        <th class="text-warning"><b> Küçük Resim </b></th>
                        <th class="text-warning"><b> Büyük Resim </b></th>
                    ...
                    $verileriCek = mysqli_query($conn, "select * from urunler");
                    ...
                    while ($b = mysqli_fetch_array($verileriCek)) {
                      ...
                      $urunadi = $b['urunadi'];
                      $kucukresim = $b['kucukresim'];
                      $buyukresim = $b['buyukresim'];

                      echo "<tr>
                            <td>$urunadi</td>
                            <td><a href='./dosyalar/$kucukresim'><img src='./dosyalar/$kucukresim'></a></td>
                            <td><a href='./dosyalar/$buyukresim'><img src='./dosyalar/$buyukresim'></td>
                            <td>
                            <a href=\"javascript:sil($id);\" ><i class='mdi mdi-delete-forever' title=Sil></i></a>
                            <a href='urunguncelle.php?id=$id&action=edit'><i class='mdi mdi-pencil' title=Düzenle></i></a>
                            </td>
                        </tr>";
                    }
