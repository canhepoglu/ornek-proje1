                                    ...
                                    <table class="table table-bordered ">
                                        ...
                                        ?>
                                            ...
                                            <tr class="w-100">
                                                ...
                                                <td>
                                                    <a href=<?= "javascript:silmakale($id);" ?>><i class='mdi mdi-delete-forever' title=Sil></i></a>
                                                    <a href='makaleguncelle.php?id=$id&action=edit'><i class='mdi mdi-pencil' title=Düzenle></i></a>
                                                </td>
                                            </tr>
