...
if (isset($_POST['yukle'])) {
    ...
    $makale = $_POST["makale"];
    $yazar = $_POST["yazar"];
    $makaleresmi = $_FILES["makaleresmi"]["tmp_name"];
    $filename = $_FILES["makaleresmi"]["name"];
    $folder = "./dosyalar/" . $filename;
    $sql = "INSERT INTO `makaleler` (`makaleresmi`, `makalebaslik`, `makale`, `yazar`) VALUES ('$filename', '$makalebaslik', '$makale', '$yazar')";

    mysqli_query($conn, $sql);

    if (move_uploaded_file($makaleresmi, $folder)) {
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="" method="post" enctype="multipart/form-data">
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            <td>Makale Resmi</td>
                                                            <td><input type="file" name="makaleresmi" class="form-control" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Makale Başlığı</td>
                                                            <td><input type="text" name="makalebaslik" class="form-control" /></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Makale</td>
                                                            <td><textarea type="text" name="makale" class="form-control"></textarea></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Yazar</td>
                                                            <td><input type="text" name="yazar" class="form-control" /></td>
                                                        </tr>

                                                        <tr>
                                                            <td></td>
                                                            <td><input class="btn btn-primary" type="submit" name="yukle" value="Ekle"></td>
                                                        </tr>
