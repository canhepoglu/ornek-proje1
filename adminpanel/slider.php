...
switch ($_GET["action"]) {
  case "delete":
    $id = $_GET['id'];
    $sliderquery = mysqli_query($conn, "SELECT * FROM slider WHERE id='$id'");
    $slider = mysqli_fetch_assoc($sliderquery);

    unlink("./dosyalar/" . $slider["resim"]);
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <button type="button" class="btn btn-light"><a href="sliderekle.php">Slider Ekle</a></button></br>

                <script>
                  function sil(id) {
                    if (confirm('Silinsin mi?')) {
                      window.location.href = "slider.php?id=" + id + "&action=delete";
                    }
                  }
                </script>
                ...
                <div class="table-responsive"></br>
                  <table class="table table-bordered ">
                    <thead>
                      <tr>
                        <th class="text-warning"><b> Slider Adı </b> </th>
                        <th class="text-warning"><b> Resim </b></th>
                        <th class="text-warning"><b> İnterval </b></th>
                      </tr>
                    </thead>
                    ...
                    $verileriCek = mysqli_query($conn, "select * from slider");
                    ...
                    while ($b = mysqli_fetch_array($verileriCek)) {
                      ...
                      echo "<tr>
                            <td>$slideradi</td>
                            <td><a href='../image/$resim'><img src='../image/$resim'></a></td>
                            <td>$interval</td>
                            <td>
                            <a href=\"javascript:sil($id);\" ><i class='mdi mdi-delete-forever' title=Sil></i></a>
                            <a href='sliderguncelle.php?id=$id&action=edit'><i class='mdi mdi-pencil' title=Düzenle></i></a>
                            </td>
                        </tr>";
                    }
